...
<div class="permohonan-form">
    ...
    <?= $form->field($model, 'user_id')->textInput(['value'=>Yii::$app->user->identity->id, 'readonly' => true])->label('User ID') ?>

    <?= $form->field($model, 'permohonan_tarikh')->textInput(['value'=>date('Y-m-d h:m:s'), 'readonly' => true])->label('Tarikh permohonan') ?>
...
<div class="1 box">
    <div class="panel panel-default">          
        ...
        <div class="panel-body">
            ...
            <?= $form->field($model, 'katPermohonan_id')->textInput(['value'=>1, 'readonly' => true])->label('Kategori permohonan') ?>
...
<div class="2 box">
    <div class="panel panel-default">          
        ...
        <div class="panel-body">
            <?= $form->field($model, 'katPermohonan_id')->textInput(['value'=>2, 'readonly' => true])->label('Kategori permohonan') ?>
        </div>
    </div>
</div>
...
<div class="3 box">
    <div class="panel panel-default">          
        ...
        <div class="panel-body">
            <?= $form->field($model, 'katPermohonan_id')->textInput(['value'=>3, 'readonly' => true])->label('Kategori permohonan') ?>
    ...
    <?= $form->field($model, 'statusPermohonan_id')->textInput(['value'=>'1', 'readonly' => true])->label('') ?>
